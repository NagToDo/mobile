...
export default function AuthScreen() {
  ...
  return (
    ...
    >
      ...
      <View className="flex-row bg-black/5 dark:bg-white/5 rounded-2xl p-1">
        <Pressable
          className={`flex-1 rounded-xl p-3 items-center ${
            mode === "login" ? "bg-white dark:bg-neutral-900" : "bg-transparent"
          }`}
      ...
      <View className="gap-3">
        <Button
          variant="outline"
          className="h-12 rounded-xl border border-black/10 dark:border-white/20 bg-white dark:bg-neutral-900"
